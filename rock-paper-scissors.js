let scores = JSON.parse(localStorage.getItem('scores')) || {
    ...
    function playGame(playerMove) {
        ...
        document.querySelector('.js-urpick').innerHTML = `<img class="move-icon " src="images/${playerMove}-emoji.png" alt="">`;
        document.querySelector('.js-compick').innerHTML = `<img class="move-icon " src="images/${computerMove}-emoji.png" alt="">`;
